...
public class Assignment1 extends JFrame implements DocumentListener {
    ...
    JTextField content1=new JTextField();
    ...
    void about(){
        JOptionPane.showMessageDialog(null,"The Test Editor is made by" +name1+" and "+ name2+"and our id are"+num1+" and "+num2);
    }
        ...
        public void actionPerformed(ActionEvent e) {
            if(e.getSource()instanceof JMenuItem){
                ...
                if(e.getActionCommand()=="Search"){
                    JFrame frame = new JFrame("Search and change diagram");
                    frame.setVisible(true);
                    frame.setLocation(270, 200);
                    frame.setSize(300,200);
                    frame.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
                    JLabel label1=new JLabel("change content");
                    JLabel label = new JLabel("Search content");
                    content.setBounds(90, 20, 180, 30);
                    content1.setBounds(90,50,180,30);
                    frame.add(content);
                    frame.add(content1);
                    frame.add(label);
//                    frame.add(label1);
